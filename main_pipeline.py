...
scripts = [
    ...
    #"PD_LGD_EAD_Modelling/PD/PD_models.py",    # Tranform the file first to maybe add if __name__ == "__main__":, check if maybe you dont want to combine this with Montecarlo in one single file
